...
class _AgregarProductoPageState extends State<AgregarProductoPage> {
  ...
  void _subirProducto(BuildContext context) async {
    ...
    // Hacemos validación de imagen y categoría
    if (_image != null && producto.categoria != null) {
      ...
      // Mostramos Toast de Producto Agregado Correctamente
      ...
      // Mostramos AlertDialog con el requerimiento de Foto y Categoria
      utils.mostrarDialog(context, 'Seleccionar', 
        'Debe seleccionar imagen y categoría', 'Aceptar', '', null, null);
